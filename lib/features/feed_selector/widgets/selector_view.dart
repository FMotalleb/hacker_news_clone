...
class SelectorSegment extends StatelessWidget with LogableObject {
  ...
  Widget getActiveIconOf(BuildContext context, HNFeedType feed) {
    final icon = switch (feed) {
      HNFeedType.bestStories => Icons.star_rate_rounded,
      HNFeedType.newStories => Icons.newspaper_rounded,
      HNFeedType.topStories => Icons.thumb_up_off_alt_rounded,
    };
